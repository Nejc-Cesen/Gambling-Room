    ...
    <div id="title"></div>
        <div id="center" class="igram">
            <form name="Obrazec" id="obrazec" method="post" autocomplete="off" action="<?php if($_SESSION["stevVrz"]==$_SESSION["stevMet"]){echo 'konec.php';}else{echo 'igra.php';}?>">
                ...
                <div class=dol>
                        <input class="button-5" type="submit" id="gumb" value="<?php if($_SESSION["stevVrz"]==$_SESSION["stevMet"]){echo 'Rezultat';}else {echo 'Vrži';}  ?>">
                    </br>
                        Met: <?php echo $_SESSION["stevVrz"]  ?>/<?php echo $_SESSION["stevMet"]  ?>
                </div>
            </form>
        </div>
        </div>
